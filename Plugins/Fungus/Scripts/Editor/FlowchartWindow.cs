...
namespace Fungus.EditorUtils
{
    public class FlowchartWindow : EventWindow
    {
        ...
        private static readonly Vector2[] pointsA = new Vector2[4];
        private static readonly Vector2[] pointsB = new Vector2[4];
        ...
        private static readonly IndexPair[] closestCornerIndexPairs = new IndexPair[]
        {
        ...
        private static readonly Vector3[] beizerWorkSpace = new Vector3[3];
